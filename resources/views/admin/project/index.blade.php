                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col text-left">
                                                    <div class="form-group">
                                                        <label for="name=project" class="form-control-label">Project Name</label>
                                                        <input type="text" id="name-project" class="form-control"
                                                            name="name" placeholder="Project name..">
                                                    </div>
                                                </div>
                                ...
                                @foreach ($projects as $prj)
                                    <tr>
                                        ...
                                        <td class="table-actions">
                                                                    ...
                                                                    <div class="col text-left">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" id="input-name"
                                                                                ...
                                                                                value="{{ old('name', $prj->name) }}" autocomplete="name" autofocus>
                                                                            @if ($errors->has('name'))
                                            ...
                                            <form action="/project/{{ $prj->id_project }}" method="post" class="d-inline">
                                                {{ method_field('delete') }}
                                                {{ csrf_field() }}
                                                <button type="submit" class="badge bg-danger">Delete</button>
                                                {{-- <a type="button" class="table-action">
